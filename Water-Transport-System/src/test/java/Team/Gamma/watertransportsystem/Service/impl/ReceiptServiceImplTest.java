...
import Team.Gamma.watertransportsystem.Repository.ReceiptRepository;
...
@ExtendWith(MockitoExtension.class)  // Ensure mocks are initialized
 class ReceiptServiceImplTest {
    ...
    @Test
    void testInvalidBookingForUser() {
        Long userId = 999L;
        User validUser = new User();
        validUser.setUserid(userId);
...
//    }
    ...
    @Test void testZeroAmountInBooking() {
        Long userId = 1L;
        User validUser = new User();
        validUser.setUserid(userId);
    ...
    @Test
    void testGenerateReceiptWithFutureDate() {
        Long userId = 1L;
        User validUser = new User();
        validUser.setUserid(userId);
